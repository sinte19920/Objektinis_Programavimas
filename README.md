...
## Vartotojas turi galimybę pasirinkti skaityti duomenis iš jau egzistuojančių failų.
Programos pradžioje paklausiama su kuo dirbti: su naujai sugeneruotais failais ar jau su egzsituojančiais. Yra galimybė ir išsirinkti vieną iš siūlomų failų (failų pavadinimai parodomi prieš pasirinkimą).
